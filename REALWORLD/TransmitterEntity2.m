function [txWaveform, waveformInfo, trBlk, trBlkSizes] = TransmitterEntity2(carrier, pdsch, encodeDLSCH, harqEntity, newPrecodingWeight, codeRate, data, nTxAnts, decodeDLSCH)
