...
pusch.Enable = true;
pusch.Label = 'PUSCH sequence for G-FR1-A1-1';
pusch.Power = 0;
...
pusch.NRAPID = [];
pusch.Coding = true;
pusch.TargetCodeRate = 0.30078125;
pusch.XOverhead = 0;
pusch.RVSequence = 0;
pusch.DataSource = zeros(100, 1);
...
x1 = ofdmdemod(waveform,nfft,cplen);
